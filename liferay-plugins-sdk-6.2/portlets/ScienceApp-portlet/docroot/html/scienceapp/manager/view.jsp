...
<c:if test='<%=hasPermission%>' >
	...
	<liferay-ui:search-container emptyResultsMessage="you-have-not-registered-any-scienceapp-yet"> 
		<liferay-ui:search-container-results
			results='<%= ScienceAppLocalServiceUtil.getScienceAppListByAuthorId(themeDisplay.getUserId(), searchContainer.getStart(), searchContainer.getEnd()) %>'
	...
	<aui:script>
		Liferay.provide(
		        ...
		        ['aui-base','aui-io-request','liferay-util-window']
		);
		...
		Liferay.provide(
	        ...
	        ['liferay-util-window', 'aui-io-request']
		);
		...
		Liferay.provide(
		        ...
		        ['aui-base', 'liferay-util-window', 'aui-io-request']
			);
