...
public class CommonModuleClp extends BaseModelImpl<CommonModule>
	...
	public void setIsLoaded(boolean isLoaded) {
		...
		if (_commonModuleRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setIsLoaded", boolean.class);

				method.invoke(_commonModuleRemoteModel, isLoaded);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>isLoaded</column-name><column-value><![CDATA[");
		sb.append(getIsLoaded());
		sb.append("]]></column-value></column>");
