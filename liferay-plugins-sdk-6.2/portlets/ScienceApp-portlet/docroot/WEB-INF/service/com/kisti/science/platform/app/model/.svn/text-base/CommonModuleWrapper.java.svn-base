...
public class CommonModuleWrapper implements CommonModule,
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("isLoaded", getIsLoaded());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		Boolean isLoaded = (Boolean)attributes.get("isLoaded");
	...
	*/
	...
	/**
	* Returns the is loaded of this common module.
	*
	* @return the is loaded of this common module
	*/
	@Override
	public boolean getIsLoaded() {
		return _commonModule.getIsLoaded();
	}

	/**
	* Returns <code>true</code> if this common module is is loaded.
	*
	* @return <code>true</code> if this common module is is loaded; <code>false</code> otherwise
	*/
	@Override
	public boolean isIsLoaded() {
		return _commonModule.isIsLoaded();
	}

	/**
	* Sets whether this common module is is loaded.
	*
	* @param isLoaded the is loaded of this common module
	*/
	@Override
	public void setIsLoaded(boolean isLoaded) {
		_commonModule.setIsLoaded(isLoaded);
	}
