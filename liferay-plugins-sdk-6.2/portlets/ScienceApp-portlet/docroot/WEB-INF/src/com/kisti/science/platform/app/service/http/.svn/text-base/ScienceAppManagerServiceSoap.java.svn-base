...
public class ScienceAppManagerServiceSoap {
	...
	*/
	public static java.lang.String executeCommand(java.lang.String command)
		throws RemoteException {
		try {
			java.lang.String returnValue = ScienceAppManagerServiceUtil.executeCommand(command);
	...
	*/
	public static java.lang.String makeDir(java.lang.String givenPath)
		throws RemoteException {
		try {
			java.lang.String returnValue = ScienceAppManagerServiceUtil.makeDir(givenPath);
	...
	public static java.lang.String executeLibInstall(
		...
		throws RemoteException {
		try {
			java.lang.String returnValue = ScienceAppManagerServiceUtil.executeLibInstall(uploadedLibFileLocation,
					fileName);
	...
	public static java.lang.String remoteMakeDir(java.lang.String hostName,
		...
		try {
			java.lang.String returnValue = ScienceAppManagerServiceUtil.remoteMakeDir(hostName,
					portNumber, userID, password);
