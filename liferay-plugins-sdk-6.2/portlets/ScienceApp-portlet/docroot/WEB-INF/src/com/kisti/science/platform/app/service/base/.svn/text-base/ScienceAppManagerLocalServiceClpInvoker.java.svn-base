...
public class ScienceAppManagerLocalServiceClpInvoker {
	public ScienceAppManagerLocalServiceClpInvoker() {
		...
		_methodName104 = "addScienceAppManager";

		_methodParameterTypes104 = new String[] { "long", "long" };

		_methodName105 = "removeScienceAppManagerByManagerId";

		_methodParameterTypes105 = new String[] { "long" };

		_methodName106 = "removeScienceAppManagerByScienceAppId";

		_methodParameterTypes106 = new String[] { "long" };

		_methodName107 = "getScienceAppIdsByManagerId";

		_methodParameterTypes107 = new String[] { "long" };

		_methodName108 = "getScienceAppIdsByManagerId";

		_methodParameterTypes108 = new String[] { "long", "int", "int" };

		_methodName109 = "countScienceAppIdsByManagerId";

		_methodParameterTypes109 = new String[] { "long" };

		_methodName110 = "getManagerIdsByScienceAppId";

		_methodParameterTypes110 = new String[] { "long" };

		_methodName111 = "getManagerIdsByScienceAppId";

		_methodParameterTypes111 = new String[] { "long", "int", "int" };

		_methodName112 = "countManagersByScienceAppId";

		_methodParameterTypes112 = new String[] { "long" };

		_methodName113 = "existScienceAppManager";
