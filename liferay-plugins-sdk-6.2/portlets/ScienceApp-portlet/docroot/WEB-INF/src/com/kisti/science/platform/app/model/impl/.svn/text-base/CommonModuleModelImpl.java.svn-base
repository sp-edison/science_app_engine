...
public class CommonModuleModelImpl extends BaseModelImpl<CommonModule>
	...
	public static final String TABLE_SQL_CREATE = "create table ScienceApp_CommonModule (groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,moduleName VARCHAR(75) not null primary key,moduleRootDir VARCHAR(75) null,isLoaded BOOLEAN)";
	...
	public static CommonModule toModel(CommonModuleSoap soapModel) {
		...
		model.setIsLoaded(soapModel.getIsLoaded());
	...
	public Object clone() {
		...
		commonModuleImpl.setIsLoaded(getIsLoaded());
	...
	public CacheModel<CommonModule> toCacheModel() {
		...
		commonModuleCacheModel.isLoaded = getIsLoaded();
