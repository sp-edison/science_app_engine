...
import science.platform.service.SpUserLocalService;
...
/**
 * Provides the base implementation for the sp user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link science.platform.service.impl.SpUserLocalServiceImpl}.
 * </p>
 *
 * @author Jerry h. Seo
 * @see science.platform.service.impl.SpUserLocalServiceImpl
 * @see science.platform.service.SpUserLocalServiceUtil
 * @generated
 */
public abstract class SpUserLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SpUserLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link science.platform.service.SpUserLocalServiceUtil} to access the sp user local service.
	 */
	...
	@Override
	public SpUser addSpUser(SpUser spUser) throws SystemException {
		spUser.setNew(true);

		return spUserPersistence.update(spUser);
	}
	 ...
	 */
	@Override
	public SpUser createSpUser(long spUserId) {
		return spUserPersistence.create(spUserId);
	}
	...
	@Override
	public SpUser deleteSpUser(long spUserId)
		throws PortalException, SystemException {
		return spUserPersistence.remove(spUserId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SpUser deleteSpUser(SpUser spUser) throws SystemException {
		return spUserPersistence.remove(spUser);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SpUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return spUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return spUserPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return spUserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return spUserPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public SpUser fetchSpUser(long spUserId) throws SystemException {
		return spUserPersistence.fetchByPrimaryKey(spUserId);
	}
	 ...
	 */
	@Override
	public SpUser getSpUser(long spUserId)
		throws PortalException, SystemException {
		return spUserPersistence.findByPrimaryKey(spUserId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return spUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SpUser> getSpUsers(int start, int end)
		throws SystemException {
		return spUserPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSpUsersCount() throws SystemException {
		return spUserPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SpUser updateSpUser(SpUser spUser) throws SystemException {
		return spUserPersistence.update(spUser);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("science.platform.model.SpUser",
			spUserLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"science.platform.model.SpUser");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = spUserPersistence.getDataSource();
	...
	private SpUserLocalServiceClpInvoker _clpInvoker = new SpUserLocalServiceClpInvoker();
}