...
import science.platform.service.base.SpUserDomainLocalServiceBaseImpl;
...
/**
 * The implementation of the sp user domain local service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link com.kisti.localize.user.service.SpUserDomainLocalService} interface.
 *
 * <p>
 ...
 *
 * @author Jerry H. Seo
 * @see com.kisti.localize.user.service.base.SpUserDomainLocalServiceBaseImpl
 * @see com.kisti.localize.user.service.SpUserDomainLocalServiceUtil
 */
public class SpUserDomainLocalServiceImpl
	extends SpUserDomainLocalServiceBaseImpl {
	public SpUserDomain createSpUserDomain(long spUserId, long spDomainId) throws SystemException {
		...
		userDomain = super.createSpUserDomain(newUserDomainId);
