...
import science.platform.service.SpRegionLocalService;
...
/**
 * Provides the base implementation for the sp region local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link science.platform.service.impl.SpRegionLocalServiceImpl}.
 * </p>
 *
 * @author Jerry h. Seo
 * @see science.platform.service.impl.SpRegionLocalServiceImpl
 * @see science.platform.service.SpRegionLocalServiceUtil
 * @generated
 */
public abstract class SpRegionLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SpRegionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link science.platform.service.SpRegionLocalServiceUtil} to access the sp region local service.
	 */
	...
	@Override
	public SpRegion addSpRegion(SpRegion spRegion) throws SystemException {
		spRegion.setNew(true);

		return spRegionPersistence.update(spRegion);
	}
	 ...
	 */
	@Override
	public SpRegion createSpRegion(long spRegionId) {
		return spRegionPersistence.create(spRegionId);
	}
	...
	@Override
	public SpRegion deleteSpRegion(long spRegionId)
		throws PortalException, SystemException {
		return spRegionPersistence.remove(spRegionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SpRegion deleteSpRegion(SpRegion spRegion) throws SystemException {
		return spRegionPersistence.remove(spRegion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SpRegion.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return spRegionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return spRegionPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return spRegionPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return spRegionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SpRegion fetchSpRegion(long spRegionId) throws SystemException {
		return spRegionPersistence.fetchByPrimaryKey(spRegionId);
	}
	 ...
	 */
	@Override
	public SpRegion getSpRegion(long spRegionId)
		throws PortalException, SystemException {
		return spRegionPersistence.findByPrimaryKey(spRegionId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return spRegionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SpRegion> getSpRegions(int start, int end)
		throws SystemException {
		return spRegionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSpRegionsCount() throws SystemException {
		return spRegionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SpRegion updateSpRegion(SpRegion spRegion) throws SystemException {
		return spRegionPersistence.update(spRegion);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("science.platform.model.SpRegion",
			spRegionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"science.platform.model.SpRegion");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = spRegionPersistence.getDataSource();
	...
	private SpRegionLocalServiceClpInvoker _clpInvoker = new SpRegionLocalServiceClpInvoker();
}