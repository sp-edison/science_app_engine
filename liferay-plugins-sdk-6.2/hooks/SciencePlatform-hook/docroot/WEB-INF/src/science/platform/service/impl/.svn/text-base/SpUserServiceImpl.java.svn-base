...
import science.platform.service.base.SpUserServiceBaseImpl;
...
/**
 * The implementation of the sp user remote service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link com.kisti.localize.user.service.SpUserService} interface.
 *
 * <p>
 ...
 *
 * @author Jerry H. Seo
 * @see com.kisti.localize.user.service.base.SpUserServiceBaseImpl
 * @see com.kisti.localize.user.service.SpUserServiceUtil
 */
public class SpUserServiceImpl extends SpUserServiceBaseImpl {
	...
	public SpUser addSpUser(SpUser spUser, long[] domainIds) throws SystemException{
		for(long domainId : domainIds){
			SpUserDomain spUserDomain = SpUserDomainLocalServiceUtil.createSpUserDomain(spUser.getSpUserId(), domainId);
			SpUserDomainLocalServiceUtil.addSpUserDomain(spUserDomain);
		}
		
		return super.spUserLocalService.addSpUser(spUser);
	}
	
	public User deleteUser(long spUserId) throws PortalException, SystemException{
		super.spUserLocalService.deleteSpUser(spUserId);
	...
	public SpUser updateSpUser(SpUser spUser, long[] domainIds) throws SystemException{
		super.spUserLocalService.updateSpUser(spUser);
	...
	public SpUser addUserWithWorkflow(
			...
			for(int i=0; i<domainIds.length; i++){
				...
				SpUserDomain userDomain = SpUserDomainLocalServiceUtil.createSpUserDomain(spUser.getSpUserId(), domainIds[i]);
				SpUserDomainLocalServiceUtil.addSpUserDomain(userDomain);
			}
