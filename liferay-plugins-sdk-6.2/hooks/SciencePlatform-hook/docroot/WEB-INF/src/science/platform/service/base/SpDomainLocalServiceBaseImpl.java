...
import science.platform.service.SpDomainLocalService;
...
/**
 * Provides the base implementation for the sp domain local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link science.platform.service.impl.SpDomainLocalServiceImpl}.
 * </p>
 *
 * @author Jerry h. Seo
 * @see science.platform.service.impl.SpDomainLocalServiceImpl
 * @see science.platform.service.SpDomainLocalServiceUtil
 * @generated
 */
public abstract class SpDomainLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SpDomainLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link science.platform.service.SpDomainLocalServiceUtil} to access the sp domain local service.
	 */
	...
	@Override
	public SpDomain addSpDomain(SpDomain spDomain) throws SystemException {
		spDomain.setNew(true);

		return spDomainPersistence.update(spDomain);
	}
	 ...
	 */
	@Override
	public SpDomain createSpDomain(long spDomainId) {
		return spDomainPersistence.create(spDomainId);
	}
	...
	@Override
	public SpDomain deleteSpDomain(long spDomainId)
		throws PortalException, SystemException {
		return spDomainPersistence.remove(spDomainId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SpDomain deleteSpDomain(SpDomain spDomain) throws SystemException {
		return spDomainPersistence.remove(spDomain);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SpDomain.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return spDomainPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return spDomainPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return spDomainPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return spDomainPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SpDomain fetchSpDomain(long spDomainId) throws SystemException {
		return spDomainPersistence.fetchByPrimaryKey(spDomainId);
	}
	 ...
	 */
	@Override
	public SpDomain getSpDomain(long spDomainId)
		throws PortalException, SystemException {
		return spDomainPersistence.findByPrimaryKey(spDomainId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return spDomainPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SpDomain> getSpDomains(int start, int end)
		throws SystemException {
		return spDomainPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSpDomainsCount() throws SystemException {
		return spDomainPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SpDomain updateSpDomain(SpDomain spDomain) throws SystemException {
		return spDomainPersistence.update(spDomain);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("science.platform.model.SpDomain",
			spDomainLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"science.platform.model.SpDomain");
	}
	...
	private SpDomainLocalServiceClpInvoker _clpInvoker = new SpDomainLocalServiceClpInvoker();
}