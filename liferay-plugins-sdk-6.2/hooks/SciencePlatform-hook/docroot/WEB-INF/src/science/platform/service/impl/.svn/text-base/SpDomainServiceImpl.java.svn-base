...
import science.platform.service.base.SpDomainServiceBaseImpl;
...
/**
 * The implementation of the sp domain remote service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link com.kisti.localize.user.service.SpDomainService} interface.
 *
 * <p>
 ...
 *
 * @author Jerry H. Seo
 * @see com.kisti.localize.user.service.base.SpDomainServiceBaseImpl
 * @see com.kisti.localize.user.service.SpDomainServiceUtil
 */
public class SpDomainServiceImpl extends SpDomainServiceBaseImpl {
	public SpDomain createSpDomain(String domainCode) throws SystemException{
		...
		domain = super.spDomainPersistence.create(newDomainId);
