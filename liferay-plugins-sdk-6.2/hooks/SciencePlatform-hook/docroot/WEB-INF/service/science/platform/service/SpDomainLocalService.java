...
/**
 * Provides the local service interface for SpDomain. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jerry h. Seo
 * @see SpDomainLocalServiceUtil
...
public interface SpDomainLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SpDomainLocalServiceUtil} to access the sp domain local service. Add custom service methods to {@link science.platform.service.impl.SpDomainLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
