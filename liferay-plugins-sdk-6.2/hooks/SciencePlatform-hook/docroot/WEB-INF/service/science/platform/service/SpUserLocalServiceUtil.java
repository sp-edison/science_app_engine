...
/**
 * Provides the local service utility for SpUser. This utility wraps
 * {@link science.platform.service.impl.SpUserLocalServiceImpl} and is the
 ...
 * @see science.platform.service.base.SpUserLocalServiceBaseImpl
 * @see science.platform.service.impl.SpUserLocalServiceImpl
 * @generated
 */
public class SpUserLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link science.platform.service.impl.SpUserLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static science.platform.model.SpUser addSpUser(
		...
		return getService().addSpUser(spUser);
	}
	...
	*/
	public static science.platform.model.SpUser createSpUser(long spUserId) {
		return getService().createSpUser(spUserId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static science.platform.model.SpUser deleteSpUser(
		science.platform.model.SpUser spUser)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteSpUser(spUser);
	}
	...
	*/
	...
	public static science.platform.model.SpUser fetchSpUser(long spUserId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchSpUser(spUserId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static science.platform.model.SpUser getSpUser(long spUserId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getSpUser(spUserId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<science.platform.model.SpUser> getSpUsers(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getSpUsers(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getSpUsersCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getSpUsersCount();
	}
	...
	*/
	public static science.platform.model.SpUser updateSpUser(
		science.platform.model.SpUser spUser)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSpUser(spUser);
	}
	...
	*/
	...
	public static SpUserLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					SpUserLocalService.class.getName());

			if (invokableLocalService instanceof SpUserLocalService) {
				_service = (SpUserLocalService)invokableLocalService;
			}
			else {
				_service = new SpUserLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(SpUserLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(SpUserLocalService service) {
	}

	private static SpUserLocalService _service;
}