...
/**
 * Provides the remote service interface for SpRegion. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Jerry h. Seo
 * @see SpRegionServiceUtil
...
public interface SpRegionService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SpRegionServiceUtil} to access the sp region remote service. Add custom service methods to {@link science.platform.service.impl.SpRegionServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
