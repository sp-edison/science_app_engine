...
/**
 * Provides the remote service interface for SpUser. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Jerry h. Seo
 * @see SpUserServiceUtil
...
public interface SpUserService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SpUserServiceUtil} to access the sp user remote service. Add custom service methods to {@link science.platform.service.impl.SpUserServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
