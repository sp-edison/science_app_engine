...
/**
 * Provides the remote service interface for SpUserDomain. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Jerry h. Seo
 * @see SpUserDomainServiceUtil
...
public interface SpUserDomainService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SpUserDomainServiceUtil} to access the sp user domain remote service. Add custom service methods to {@link science.platform.service.impl.SpUserDomainServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
