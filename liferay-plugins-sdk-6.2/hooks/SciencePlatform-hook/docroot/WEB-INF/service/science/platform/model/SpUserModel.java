...
/**
 * The base model interface for the SpUser service. Represents a row in the &quot;SciencePlatformHook_SpUser&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link science.platform.model.impl.SpUserModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link science.platform.model.impl.SpUserImpl}.
 * </p>
 *
 * @author Jerry h. Seo
 * @see SpUser
 ...
 * @generated
 */
public interface SpUserModel extends BaseModel<SpUser> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a sp user model instance should use the {@link SpUser} interface instead.
	 */
	...
	@Override
	public CacheModel<science.platform.model.SpUser> toCacheModel();
