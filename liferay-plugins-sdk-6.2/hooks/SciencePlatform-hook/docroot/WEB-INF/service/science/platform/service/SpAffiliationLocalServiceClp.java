 ...
 * @generated
 */
public class SpAffiliationLocalServiceClp implements SpAffiliationLocalService {
	public SpAffiliationLocalServiceClp(
		...
		_methodName19 = "createSpAffiliation";
		...
		_methodName21 = "getAllAffiliationsJSON";

		_methodParameterTypes21 = new String[] { "java.util.Locale" };

		_methodName22 = "getSpAffiliationListByCountryId";

		_methodParameterTypes22 = new String[] { "long" };

		_methodName23 = "getSpAffiliationListByRegionId";

		_methodParameterTypes23 = new String[] { "long" };

		_methodName24 = "getAffiliationNamesByCountryId";

		_methodParameterTypes24 = new String[] { "long", "java.util.Locale" };

		_methodName25 = "getAffiliationNamesByRegionId";

		_methodParameterTypes25 = new String[] { "long", "java.util.Locale" };

		_methodName26 = "isExist";
	...
	public science.platform.model.SpAffiliation addSpAffiliation(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(spAffiliation) });
		}
		catch (Throwable t) {
		...
		return (science.platform.model.SpAffiliation)ClpSerializer.translateOutput(returnObj);
	}
	...
	public science.platform.model.SpAffiliation createSpAffiliation(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { spAffiliationId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public science.platform.model.SpAffiliation deleteSpAffiliation(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { spAffiliationId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public science.platform.model.SpAffiliation fetchSpAffiliation(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { spAffiliationId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public science.platform.model.SpAffiliation getSpAffiliation(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { spAffiliationId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<science.platform.model.SpAffiliation> getSpAffiliations(
		...
		return (java.util.List<science.platform.model.SpAffiliation>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public science.platform.model.SpAffiliation createSpAffiliation(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					ClpSerializer.translateInput(affiliationCode)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<science.platform.model.SpAffiliation> getSpAffiliationListByCountryId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName22,
					_methodParameterTypes22, new Object[] { countryId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
