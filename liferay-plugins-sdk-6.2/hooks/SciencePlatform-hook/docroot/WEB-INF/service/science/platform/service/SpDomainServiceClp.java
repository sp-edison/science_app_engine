 ...
 * @generated
 */
public class SpDomainServiceClp implements SpDomainService {
	public SpDomainServiceClp(InvokableService invokableService) {
		...
		_methodName7 = "getAllDomainsJSON";

		_methodParameterTypes7 = new String[] { "java.util.Locale" };

		_methodName8 = "getDomainNamesByUserId";

		_methodParameterTypes8 = new String[] { "long", "java.util.Locale" };

		_methodName9 = "isExist";
	...
	public void addUserDomain(long userId, long domainId)
		...
		try {
			_invokableService.invokeMethod(_methodName4,
				_methodParameterTypes4, new Object[] { userId, domainId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
