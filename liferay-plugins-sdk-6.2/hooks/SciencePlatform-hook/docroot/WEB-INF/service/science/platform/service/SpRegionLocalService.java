...
/**
 * Provides the local service interface for SpRegion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jerry h. Seo
 * @see SpRegionLocalServiceUtil
...
public interface SpRegionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SpRegionLocalServiceUtil} to access the sp region local service. Add custom service methods to {@link science.platform.service.impl.SpRegionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
